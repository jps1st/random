...
import com.jps.l2app.server.ui.GlobalLimits;
 ...
 * @author admin
 */
public final class ProntonMain extends javax.swing.JFrame {

    private static final boolean showPrintPreview = false;

    private static ProntonMain instance;

    public static ProntonMain getInstance() {
        if (instance == null) {
            instance = new ProntonMain();
    ...
    public ProntonMain() {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                ProntonMain.this.setExtendedState(Frame.MAXIMIZED_BOTH);
            }
        });
    ...
    private void initComponents() {
        ...
        raffleCombo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "L2", "L3", "S3", "S2", "S3R", "P42", "P45", "P49", "P55", "4D" }));
        ...
        jMenuItem11.setMnemonic('3');
        jMenuItem11.setText("3. S3");
        ...
        jMenuItem12.setMnemonic('4');
        jMenuItem12.setText("4. S2");
        ...
        jMenuItem13.setMnemonic('5');
        jMenuItem13.setText("5. S3R");
        ...
        jMenuItem14.setMnemonic('6');
        jMenuItem14.setText("6. P42");
        ...
        jMenuItem15.setMnemonic('7');
        jMenuItem15.setText("7. P45");
        ...
        jMenuItem16.setMnemonic('8');
        jMenuItem16.setText("8. P49");
        ...
        jMenuItem17.setMnemonic('9');
        jMenuItem17.setText("9. P55");
        ...
        jMenuItem18.setMnemonic('0');
        jMenuItem18.setText("10. 4D");
        ...
        detailSearch_raffle.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "ALL", "L2", "L3", "S3", "S2", "S3R", "P42", "P45", "P49", "P55", "4D" }));
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        GlobalLimits dialog = new GlobalLimits(this, true);
        dialog.pack();
    ...
    private void jMenuItem11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem11ActionPerformed
        raffleCombo.setSelectedIndex(2);
    }//GEN-LAST:event_jMenuItem11ActionPerformed

    private void jMenuItem12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem12ActionPerformed
        raffleCombo.setSelectedIndex(3);
    }//GEN-LAST:event_jMenuItem12ActionPerformed

    private void jMenuItem13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem13ActionPerformed
        raffleCombo.setSelectedIndex(4);
    }//GEN-LAST:event_jMenuItem13ActionPerformed

    private void jMenuItem14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem14ActionPerformed
        raffleCombo.setSelectedIndex(5);
    }//GEN-LAST:event_jMenuItem14ActionPerformed

    private void jMenuItem15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem15ActionPerformed
        raffleCombo.setSelectedIndex(6);
    }//GEN-LAST:event_jMenuItem15ActionPerformed

    private void jMenuItem16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem16ActionPerformed
        raffleCombo.setSelectedIndex(7);
    }//GEN-LAST:event_jMenuItem16ActionPerformed

    private void jMenuItem17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem17ActionPerformed
        raffleCombo.setSelectedIndex(8);
    }//GEN-LAST:event_jMenuItem17ActionPerformed

    private void jMenuItem18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem18ActionPerformed
        raffleCombo.setSelectedIndex(9);
    ...
    private void printTransaction(ProntonTransaction transaction) {
        ...
        try {
            ...
            p = JasperFillManager.fillReport(ProntonMain.class.getResourceAsStream(reportFile), new HashMap(), s);
            if (showPrintPreview) {
    ...
    private void printDrawSummary(Date d, String draw) {
        ...
        try {
            ...
            p = JasperFillManager.fillReport(ProntonMain.class.getResourceAsStream(reportFile), new HashMap(), src);
