 ...
 * @author admin
 */
public class GlobalLimits extends javax.swing.JDialog {

    /**
     * Creates new form GlobalLimits
     */
    public GlobalLimits(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void refresh() {
        ...
        List<GlobalLimit> all = GlobalLimitService.getInstance().getAll(raffle, draw);
    ...
    private void initComponents() {
        ...
        l1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "L2", "L3", "S3", "S2", "S3R", "P42", "P45", "P49", "P55", "4D" };
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jButton3)
                    .addComponent(jLabel6)
                    .addComponent(winPisoSpinner, javax.swing.GroupLayout.DEFAULT_SIZE, 26, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(drawSpinner, javax.swing.GroupLayout.DEFAULT_SIZE, 26, Short.MAX_VALUE)
                    .addComponent(jLabel4)
                    .addComponent(jCheckBox1)
                    .addComponent(jButton1))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//        }
        ...
        if (limit == null) {
            GlobalLimit check = GlobalLimitService.getInstance().getLimit(draw, raffle, digit, null);
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GlobalLimits.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
